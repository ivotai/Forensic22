...
class NewTztxListFra : SimplePageFra<Tztx, KVHolder>() {
    ...
    override fun initViews() {
        super.initViews()
        mRecyclerView.background =
            ColorDrawable(ContextCompat.getColor(context!!, R.color.md_grey_200))
    ...
    override fun totalElements(totalElements: Int) {
        RxBus.post(TotalElementsEvent(index = 0, totalElements = totalElements))
    }
